const swaggerDocument = {
  ...
  paths: {
    ...
    "/v1/chat/completion": {
      post: {
        summary:
          "Endpoint in the style of the OpenAI /v1/chat/completion endpoint.",
        requestBody: {
          content: {
            "application/json": {
              examples: {
    ...
    "/score": {
      post: {
        summary:
          "The Azure ML standard inference input. This path is used by the AzureML UI.",
        requestBody: {
          content: {
            "application/json": {
              examples: {
